...
func TestTemp(t *testing.T) {
	mock := Ramp{Stripes: []RampProperties{{Colour: "green", StartPoint: 960}, {Colour: "gray", StartPoint: 960}},
		StripeGroup: layout{Header: internalHeader{Height: 0, Colour: "white"},
			InterStripe: gradientSeparator{Colours: []string{"white", "black", "red", "blue"}, Height: 1},
			Ramp:        []Gradient{{Height: 5, BitDepth: 4, Label: "4b"}, {Height: 5, BitDepth: 6, Label: "6b"}, {Height: 5, BitDepth: 8, Label: "8b"}, {Height: 5, BitDepth: 10, Label: "10b"}}},
	...
	mock.StripeGroup.Ramp = []Gradient{{Height: 20, BitDepth: 8}, {Height: 20, BitDepth: 4}}
